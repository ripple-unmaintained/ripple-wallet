var Base58 = Base58.js = require(__dirname+'/base58.js');
...
var RippleWallet = (function () {
  ...
  return function (seed) {
    this.seed = Base58.js.decode_base_check(33, seed);
    ...
    this.getAddress = function (seq) {
      ...
      return Base58.js.encode_base_check(0, sjcl.codec.bytes.fromBits(SHA256_RIPEMD160(sjcl.codec.bytes.toBits(pubKey.toBytesCompressed()))));
    };
  };
})();
